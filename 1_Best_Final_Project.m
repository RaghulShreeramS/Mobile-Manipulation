...
state_ref = [-0.2 -0.4 -0.01 0.8 -0.15 -1.6 -0.15 0.15 0 0 0 0 0]; 

% Initial error of the e-e (w.r.t state_ref) is >30 degrees and chassis is >0.2m
...
writematrix(Wrapper_output, "Wrapper_output_Best.csv")
